About pcdsdevices-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pcdsdevices-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9344&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pcdsdevices-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pcdsdevices` can be installed with `conda`:
...
```
mamba install pcdsdevices
```

It is possible to list all of the versions of `pcdsdevices` available on your platform with `conda`:
...
```
mamba search pcdsdevices --channel conda-forge
```
...
mamba repoquery search pcdsdevices --channel conda-forge

# List packages depending on `pcdsdevices`:
mamba repoquery whoneeds pcdsdevices --channel conda-forge

# List dependencies of `pcdsdevices`:
mamba repoquery depends pcdsdevices --channel conda-forge
```
