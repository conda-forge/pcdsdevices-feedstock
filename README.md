...
pixi add pcdsdevices
# for installing globally
pixi global install pcdsdevices
```
...
It is possible to list all of the versions of `pcdsdevices` available on your platform:
...
```
pixi search pcdsdevices --channel conda-forge
```
